using EstudoAprofundadoLINQ.Entities;
using System;
using System.Collections.Generic;
using System.Linq;

namespace EstudoAprofundadoLINQ
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Sigle or default teste1: " + r8);
            Console.WriteLine();

            var r9 = products.Where(p => p.Id == 30).SingleOrDefault();
            Console.WriteLine("Sigle or default teste2: " + r9);
            Console.WriteLine();
